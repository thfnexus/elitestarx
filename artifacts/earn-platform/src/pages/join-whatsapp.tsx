  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pt-4">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Official Channel</h1>
        <p className="text-slate-500">Stay updated with the latest news, payment proofs, and announcements.</p>
      </div>
      ...
      <Card className="shadow-lg border-green-100 overflow-hidden">
        ...
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl text-slate-800">Elite Starx WhatsApp</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6 text-center">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-4 text-left">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-bold text-slate-800">Instant Updates</p>
                <p className="text-[10px] text-slate-500">New ads & rewards</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="bg-green-50 p-2 rounded-lg mt-0.5">
                <ShieldCheck className="h-4 w-4 text-green-600" />
              </div>
              <div>
                <p className="text-xs font-bold text-slate-800">Payment Proofs</p>
                <p className="text-[10px] text-slate-500">Verified cashouts</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-bold text-slate-800">Direct Support</p>
                <p className="text-[10px] text-slate-500">Community help</p>
              </div>
            </div>
          </div>
