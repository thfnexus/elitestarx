...
export const getGetAdStatusQueryKey = () => {
  return [`/api/ads/status`] as const;
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getAdStatus>>> = ({
    signal,
  }) => getAdStatus({ signal, ...requestOptions });
...
export const getLiveWithdrawals = async (
  options?: RequestInit,
): Promise<LiveWithdrawal[]> => {
...
export const getGetLiveWithdrawalsQueryKey = () => {
  return [`/api/withdrawals/live-feed`] as const;
};

export const getGetLiveWithdrawalsQueryOptions = <
  TData = Awaited<ReturnType<typeof getLiveWithdrawals>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getLiveWithdrawals>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getLiveWithdrawals>>
  > = ({ signal }) => getLiveWithdrawals({ signal, ...requestOptions });
...
export type GetLiveWithdrawalsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLiveWithdrawals>>
>;
...
export function useGetLiveWithdrawals<
  TData = Awaited<ReturnType<typeof getLiveWithdrawals>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const getGlobalPoolStatus = async (
  options?: RequestInit,
...
export const getGetGlobalPoolStatusQueryKey = () => {
  return [`/api/global-pool/status`] as const;
};

export const getGetGlobalPoolStatusQueryOptions = <
  TData = Awaited<ReturnType<typeof getGlobalPoolStatus>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getGlobalPoolStatus>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getGlobalPoolStatus>>
  > = ({ signal }) => getGlobalPoolStatus({ signal, ...requestOptions });
...
export type GetGlobalPoolStatusQueryResult = NonNullable<
  Awaited<ReturnType<typeof getGlobalPoolStatus>>
>;
...
export function useGetGlobalPoolStatus<
  TData = Awaited<ReturnType<typeof getGlobalPoolStatus>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
